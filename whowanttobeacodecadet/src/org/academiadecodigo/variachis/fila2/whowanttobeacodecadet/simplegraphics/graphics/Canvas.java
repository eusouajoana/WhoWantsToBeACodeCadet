...
public class Canvas {
    ...
    public static void snapshot() {
        ...
        org.academiadecodigo.variachis.fila2.whowanttobeacodecadet.simplegraphics.graphics.Rectangle rect = new org.academiadecodigo.variachis.fila2.whowanttobeacodecadet.simplegraphics.graphics.Rectangle(0, 0, dim.width, dim.height);
    ...
    public void saveToDisk(String fileName) {
        Dimension dim = component.getPreferredSize();
        org.academiadecodigo.variachis.fila2.whowanttobeacodecadet.simplegraphics.graphics.Rectangle rect = new Rectangle(0, 0, dim.width, dim.height);
        BufferedImage image = new BufferedImage(rect.width, rect.height, BufferedImage.TYPE_INT_RGB);
