...
public enum MastersQuestions implements Question{
    ...
    FILIPE_SENTENCE("What's Filipe's favorite sentence?", new String[]{"Maltinha... Fasshentido?", "A tua prima!", "És um pussy"}),
    ...
    BOOTCAMP_JORGE("What was the name and number of Master Jorge's Bootcamp?", new String[] {"#3 Bashtards", "#3 Unixcórnios", "#4 Roothless"}),
    ...
    FILIPE_BIRTHDAY("When is Master Filipe's birthday?", new String[] {"19th September", "20th September", "18th September"}),
    JORGE_BIRTHDAY("When is Master Jorge's birthday?", new String[] {"12th October", "1st January", "The Master was not born, he was instantiated"}),
